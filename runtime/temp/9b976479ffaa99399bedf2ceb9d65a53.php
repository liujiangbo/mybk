<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:38:"./template/laozhang/download\list.html";i:1556193372;s:38:"./template/laozhang/public\header.html";i:1557141638;s:42:"./template/laozhang/public\breadcrumb.html";i:1526267824;s:38:"./template/laozhang/public\footer.html";i:1557142045;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="main">
	<div class="picture_list_container">
		...
		<?php if(is_array($lists) || $lists instanceof \think\Collection): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<li class="trans_3">
				<a target="_blank"  href="<?php echo $vo['url']; ?>" class="pic"><img class="lazy" data-original="<?php echo thumb($vo['image_url'],270,180,3); ?>" src="__TEMPLATE__laozhang/static/images/pic_loading_bg.png" alt="<?php echo $vo['title']; ?>"></a>
				...
				<div class="date_hits">
					...
					<a href="<?php echo $vo['url']; ?>" target="_blank" class="layui-btn layui-btn-primary">查看</a>
				</div>
			</li>
		<?php endforeach; endif; else: echo "" ;endif; ?>
		<div class="clear"></div>
